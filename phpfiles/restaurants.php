                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                            <div class="bg-gray restaurant-entry">
                                <div class="row">
								<?php $ress= mysqli_query($db,"select * from dishes");
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="dishes.php?res_id='.$rows['d_id'].'" > <img src="../admin/Res_img/dishes/'.$rows['img'].'" alt="Food logo"></a>
															</div>
															<!-- end:Logo -->
															<div class="entry-dscr">
																<h5><a href="dishes.php?res_id='.$rows['d_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['slogan'].' <a href="#">...</a></span>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<p> 56 Reviews</p> <a href="dishes.php?res_id='.$rows['d_id'].'" class="btn theme-btn-dash">Order Now</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
