	...
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													if($_POST['submit'])
													{
                                                        ...
                                                        $insertintoTimes = "INSERT INTO frequency(d_id,u_id, quantity) values('".$item['d_id']."','".$_SESSION["user_id"]."', '".$item["quantity"]."') "; 
                                                        $newquentyty = $item['quantity'];
                                                        $userID = $item['d_id'];
                                                        $updatetherecord = "UPDATE frequency SET quantity='$newquentyty' WHERE d_id='$userID' ";
                                                        $theuserTotalAmount = $item["quantity"]*$item["price"];
													$SQL="insert into users_orders(u_id,d_id,title,quantity,price,totalprice) values('".$_SESSION["user_id"]."','".$_SESSION['orderID']."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."', '.$theuserTotalAmount.')";
                                                    
                               
						
														mysqli_query($db,$SQL);
														mysqli_query($db,$insertintoTimes);
                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td><img src="check.png" id="TheCheckImage" alt=""> Cart Subtotal</td>
                                                        <td>Rs <?php echo $item_total; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="check.png" id="TheCheckImage" alt=""> Shipping &amp; Handling</td>
                                                        <td>FREE*</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input" selected> <span class="custom-control-indicator"></span> <span class="custom-control-description">Cash on delivery</span>
