...
<style>
    .dishimage{
       background-image: url("../images/img/dish.jpeg");
...
<body>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from dishes where d_id='$_GET[res_id]' ");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image dishimage" data-image-src="../images/img/dish.jpeg">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src = "../admin/Res_img/dishes/'.$rows['img'].'" title="BackGImage">'; ?></figure>
                                </div>
                            </div>
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from dishes where d_id='$_GET[res_id]' LIMIT 1;");
									$stmt->execute();
