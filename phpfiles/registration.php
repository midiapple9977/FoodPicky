...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
     ...
     if(empty($_POST['firstname']) ||  //fetching and find if its empty
		...
		empty($_POST['cpassword']))
		{
			$message = "<img src='close.png' id='fillAllFieldsMessage'> All fields must be Required!";
		}
	else
	{
    ...
    }elseif(strpos($_POST['email'] ,"@saegis.edu.lk") == false)
    {
        $message = "You are not a user in Saegis campus";
    }
    ...
    $check_username= mysqli_query($db, "SELECT * FROM users where phone = '".$_POST['phone']."'");
    $resultNew = mysqli_fetch_assoc($check_username);

    $_SESSION['UID'] = $resultNew['u_id'];

      $_SESSION['NewUserF_name'] = $resultNew['f_name'];
     $_SESSION['NewUserL_name'] = $resultNew['l_name'];
     $_SESSION['NewUserE_mail'] = $resultNew['email'];

     $_SESSION['username'] = $resultNew['username'];
     $_SESSION['phone'] = $resultNew['phone'];
     $_SESSION['password'] = $resultNew['password'];
     $_SESSION['address'] = $resultNew['address'];
     $_SESSION['date'] = $resultNew['date'];
		...
		?>
                            <div class="alert alert-success " role="alert">
                              Please check your <b>Outlook</b> or in junk and verify your account.
                            </div>
        <?php
		
		 header("refresh:5;url=send_mail.php"); // redireted once inserted success
    }
	}
...
<body>
         ...
         <div class="page-wrapper" >
            ...
            <section class="contact-page inner-page" data-aos="fade-up">
               <div class="container">
                  <div class="row">
                     <!-- REGISTER -->
                     <div class="col-md-8">
							  ...
							  <form action="" method="post" data-aos="fade-up">
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1"> Saegis Email address</label>
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="@saegis.edu.lk"> <small id="emailHelp" class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="Register" name="submit" class="btn theme-btn" id="TheSubmitBtn"> </p>
                                    </div>
                                 </div>
                              </form>
                     ...
                     <div class="col-md-4">
						...
						<ul>
						<li><img src="correct.png" alt="" id="TheRightImage"> Choose from Wide varities of dishes</li>
						<li><img src="correct.png" alt="" id="TheRightImage"> Live food tracking</li>
						<li><img src="correct.png" alt="" id="TheRightImage"> Easy refunds & cancellations</li>
						<li><img src="correct.png" alt="" id="TheRightImage"> Free home delivery</li>
						<li><img src="correct.png" alt="" id="TheRightImage"> Special discounts & coupons</li>
						</ul>
                        <hr>
