...
<style>
    ...
    #theToggleCell{
     ...
     #theToggleBox:hover{
        background-color: rgba(0, 47, 255, 0.174);
         
     }
     #theToggleBox input:hover{
        cursor: pointer;
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr> 
                                                                                           ...
                                                                                           <body>
                                                                                                                ...
                                                                                                                <div class="form-check form-switch" id="theToggleBox">
                                                                                                                        <input class="form-check-input" <?php if($rows['status']=='1'){echo "checked";}?> onclick="toggleStatus(<?php echo $rows['d_id'];?>)" type="checkbox" role="switch" id="check" >
                                                                                                                           <label for="check" id="TheToggleCkeck"></label>
