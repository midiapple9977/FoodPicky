...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
                   ...
                   $sql = "update dishes set c_name='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
                   //$sql = "UPDATE dishes SET title='$_POST[d_name]', slogan='$_POST[about]' , c_name='$_POST[res_name]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]' ";
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Menu for category</h4>
                            </div>
                            <div class="card-body">
