                ...
                <!-- Start Page Content -->
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><img src="images/users/money.png" alt="" id="themonetImag"></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="SELECT SUM(totalprice) AS total FROM users_orders;";
												$result=mysqli_query($db,$sql); 
													$rws= mysqli_fetch_array($result);
                                                    $resultnew = mysqli_fetch_assoc($result);
                                                    $thetotealprice = $resultnew['totalprice'];
