...
if(isset($_POST['submit']))           //if upload btn is pressed add new dish item
{
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,u_id,title,slogan,c_name, price,img) VALUE('".$_POST['res_name']."','".$_SESSION["user_id"]."','".$_POST['d_name']."','".$_POST['about']."','".str_replace(" ", "",$_POST['res_name'])."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add New Popular Dish</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Select Food Name</label>
