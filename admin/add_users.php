...
<body class="fix-header">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger" placeholder="Kumara">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lname" class="form-control" placeholder="Dilshan">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control" id="InputUserAddress"></textarea>
                                                </div>
                                            </div>
                                        </div>
    ...
    <!-- All Jquery -->
    <script>
         var InputUserAddress = document.getElementById('InputUserAddress');
        InputUserAddress.innerText="56/b Prathibimbarama Rd, Colombo";
    </script>
