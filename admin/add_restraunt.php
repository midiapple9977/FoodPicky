...
<body class="fix-header">
    ...
    <div id="main-wrapper">
       ...
       <div class="header">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Categories</span></a>
                            <ul aria-expanded="false" class="collapse">
                               <li><a href="allrestraunt.php">   </a></li>
								<li><a href="add_category.php">Add category</a></li>
                                <li><a href="add_restraunt.php"> </a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add New Popular Category</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" class="form-control" placeholder="Wambatu moju">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" id="InputThePhoneNumber"   value="0117 430 000">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <!--/row-->
                                        <h3 class="box-title m-t-40">Campus Address</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control" id="inputTheAddress"></textarea>
                                                </div>
                                            </div>
                                        </div>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
			<footer class="footer"> © 2022 All rights reserved. Made with &#x1F49C; by <b><a href=""> Saegis Campus Smarters </a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
    ...
    <script>
        ...
        var theaddres = document.getElementById('inputTheAddress');
        theaddres.innerText="135 S. De S. Jayasinghe Mawatha, Nugegoda 10250";
 
    </script>
    <script>
           var thephonenumber = document.getElementById('InputThePhoneNumber');
           thephonenumber.innerText="0117 430 000";
    </script>
